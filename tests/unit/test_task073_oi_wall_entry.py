...
class TestOIWallEntryFilter(unittest.TestCase):
    ...
    def test_ce_wall_full_lifecycle_to_qualified_and_consumed(self):
        ...
        candle1 = OHLCVCandle(timestamp=self.t0, open=24085.0, high=24085.0, low=24055.0, close=24075.0, volume=1000)
        bias1 = self._make_ce_bias(persistence=1)
    ...
    def test_pe_wall_full_lifecycle_to_qualified(self):
        ...
        candle1 = OHLCVCandle(timestamp=self.t0, open=24015.0, high=24045.0, low=24015.0, close=24025.0, volume=1000)
    ...
    def test_retest_breach_invalidates_to_expired(self):
        ...
        candle1 = OHLCVCandle(timestamp=self.t0, open=24085.0, high=24085.0, low=24065.0, close=24075.0, volume=1000)
    ...
    def test_wall_identity_change_resets_filter_state(self):
        ...
        t1 = self.t0 + timedelta(minutes=1)
        candle2 = OHLCVCandle(timestamp=t1, open=24135.0, high=24135.0, low=24070.0, close=24125.0, volume=1000)
